...
[![Версия](https://img.shields.io/badge/source-0.10.0-16A34A?labelColor=2b2925)](package.json)
...
Текущая версия исходников: **0.10.0** · готовый для RuStore AAB + нативная оболочка Tauri + классические расширенные правила + четыре уровня локального компьютера + усиленный Worker/PWA lifecycle + воспроизводимый проверяемый toolchain
...
1. Опубликовать и проверить Android AAB 0.10.0 в RuStore через отдельные app-signing и upload keys.
