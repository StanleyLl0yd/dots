...
[![Версия](https://img.shields.io/badge/source-1.0.1-16A34A?labelColor=2b2925)](package.json)
...
Текущая версия исходников: **1.0.1** · стабильный готовый для RuStore AAB + нативная оболочка Tauri + классические расширенные правила + четыре уровня локального компьютера + усиленный Worker/PWA lifecycle + воспроизводимый проверяемый toolchain
