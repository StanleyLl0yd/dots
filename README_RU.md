...
[![Версия](https://img.shields.io/badge/source-0.9.5-16A34A?labelColor=2b2925)](package.json)
...
Текущая версия исходников: **0.9.5** · готовый для RuStore AAB + нативная оболочка Tauri + классические расширенные правила + четыре уровня локального компьютера + усиленный Worker/PWA lifecycle + воспроизводимый проверяемый toolchain
...
- локализованное стартовое меню на тетрадной сетке с «Продолжить», прямым запуском игры вдвоём/против компьютера, Справкой, About, native-only «Выход» и возвратом через игровую кнопку «Меню»;
