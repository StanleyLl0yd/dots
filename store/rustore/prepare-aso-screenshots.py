...
SCREENSHOTS = (
    (
        ...
        "Окружайте соперника и захватывайте точки",
    ),
    (
        "02-vs-computer.png",
        "02-vs-computer.png",
        "Сразитесь с компьютером",
        "4 уровня сложности — от лёгкого до эксперта",
    ),
    (
        "03-start-menu.png",
        "03-help.png",
        "Играйте вдвоём офлайн",
        "На одном устройстве — без аккаунта и интернета",
    ),
    (
        "04-help.png",
        "04-about.png",
        "Поле под вашим контролем",
        "Масштаб, перемещение, отмена хода и справка",
    ),
)
