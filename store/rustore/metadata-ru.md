...
Первый стабильный выпуск Dots. Завершена подготовка приложения к публикации: усилены стабильность и защищённость сборки, сохранены правила, формат сохранений, подсчёт очков и поведение ИИ версии 0.10.0. В релиз также входят стартовое меню и отключаемые локальные звуки ходов, захватов и игровых действий.
