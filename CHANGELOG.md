...
- closed residual dependency-security gaps by explicitly denying the optional macOS `fsevents` install script and adding required/scheduled RustSec audits for both committed Cargo lockfiles, including strict authoritative-core warnings and an explicit platform-scoped Tauri GTK3 advisory exception;
