...
const messages = {
  ru: {
    ...
    boardInstructions: "Поле доступно с клавиатуры: стрелки перемещают курсор между пересечениями, Enter или Пробел ставит точку, плюс и минус меняют масштаб. Мышью или пальцем перетаскивайте поле; колесо или щипок меняют масштаб. В режиме против компьютера вы играете красными, компьютер — синими.",
    cursor: "Пересечение",
  ...
  en: {
    ...
    boardInstructions: "The board supports keyboard play: arrow keys move the cursor between grid intersections, Enter or Space places a dot, and plus or minus changes zoom. Drag with mouse or touch to pan; use the wheel or pinch to zoom. In computer mode you play Red and the computer plays Blue.",
    cursor: "Intersection",
    placed: "Dot placed",
